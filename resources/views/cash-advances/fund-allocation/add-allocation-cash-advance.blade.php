        ...
        <div class="overflow-x-auto border rounded-md">
            ...
            <table class="min-w-full text-sm text-left border-separate border-spacing-y-2">
                <thead class="text-gray-700 dark:text-gray-300">
                    <tr>
                        <th class="px-2 text-left border-b">Office</th>
                        <th class="px-2 text-left border-b">Amount</th>
                        <th class="px-2 text-left border-b">Status</th>
                        <th class="px-2 w-8 border-b"></th>
                    </tr>
                </thead>
                <tbody>
