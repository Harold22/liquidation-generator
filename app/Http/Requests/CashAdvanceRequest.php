...
class CashAdvanceRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'special_disbursing_officer.regex' => 'Special Disbursing Officer must not a contain number!',
            ...
            'cash_advance_amount.max' => 'Cash Advance Amount must not exceed 75 million!',
